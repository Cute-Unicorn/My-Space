...
def ui():
    ...
    ttk.Label(frame, text=passwords[0]).grid(column=0, row=0)
    ttk.Label(frame, text=passwords[1]).grid(column=0, row=1)
    ttk.Label(frame, text=passwords[2]).grid(column=0, row=2)
